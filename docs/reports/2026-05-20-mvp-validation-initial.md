...
- **Followup:** scenarios 8-10 と F7 は別レポート [`2026-05-20-mvp-validation-followup.md`](./2026-05-20-mvp-validation-followup.md) を参照
...
**Fixed during validation:** Scenario 7 v1 → **F1 (docs/template)**
