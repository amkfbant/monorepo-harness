...
import { evaluateCloseConditions } from "../../../src/goal/close-checks.js";
import type {
  GoalCloseCheck,
  GoalCloseCondition,
  GoalFinding,
...
function finding(overrides: Partial<GoalFinding>): GoalFinding {
  return {
    findingId: "finding-a",
    goalId: "goal-a",
    stableKey: "stable",
...
function condition(
  overrides: Partial<GoalCloseCondition>,
): GoalCloseCondition {
  return {
    id: "typecheck",
    kind: "command",
...
function check(overrides: Partial<GoalCloseCheck>): GoalCloseCheck {
  return {
    checkId: "check-a",
    goalId: "goal-a",
