 ...
 * へ behaviour-zero 分割した薄い orchestrator。command 群を 5 sub-registrar
 * （lifecycle / attempt / finding / review / convergence）へ登録順どおりに委譲し、
 * 共有 helper は hitch/helpers.ts に集約（HitchContext⇔HitchCliError の相互参照ゆえ
 * 1 モジュール）。registration 順 = commander help 列挙順 = golden 凍結。
 */
