...
import { loadReviewDecision, writeReviewDecision, serializeReviewDecision, parseReviewDecisionYaml } from "./review-decision-loader.js";
...
import { DEFAULT_REVIEW_RULE, parseReviewRuleSnapshot, ruleSha256, type ReviewRule } from "./review-rule.js";
...
import { ReviewGateError, type ProcessOpts, type ProcessResult } from "./review-processor-types.js";
import { processOverridePath, processConsensusModePath, recordConsensusForReviewProcess } from "./review-processor-paths.js";

// #125 A15: 共有 error/result 型は review-processor-types.ts、override/consensus パス
// 実装は review-processor-paths.ts へ behaviour-zero 抽出。public な error/型は外部
// import 互換のため再 export（review-processor.js から取得される）。
export {
  ReviewGateError,
  ReviewConsensusNoActiveProposalsError,
  ReviewConsensusPendingError,
  isConsensusPendingReviewGateError,
} from "./review-processor-types.js";
export type { ProcessOpts, ProcessResult } from "./review-processor-types.js";
