/**
 * Deterministic guard for the `hitch finding classify --then-rerun` auto-chain
 ...
 * hitch at `needs_fix` (an open in-scope finding the coder can address). For any
 ...
 *   - anything else — let the operator drive `hitch orchestrate` deliberately.
 *
 ...
 */
import type { HitchConvergenceDecision } from "./types.js";
...
export function classifyChainDecision(
  thenRerun: boolean,
  decisionAfter: HitchConvergenceDecision,
