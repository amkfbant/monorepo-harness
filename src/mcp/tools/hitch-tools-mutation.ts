// hitch mutation MCP tool factory（start/record/classify/.../close/cancel/expand）。
// record_findings/classify/close の db.transaction().immediate() atomic seam を保持。

import { harnessPaths } from "../../config/paths.js";

import { classifyFindingForHitch } from "../../hitch/classification.js";
import { ConvergenceService } from "../../hitch/convergence.js";
import { evaluateConvergenceAndRecordStatus, recordConvergenceDecisionWithStatus } from "../../hitch/convergence-status.js";
import { deferFindingToBacklog } from "../../hitch/followups.js";
import { nextReviewMode } from "../../hitch/review-mode.js";
import { HitchRepository, type CreateHitchSessionInput, type UpsertHitchFindingInput } from "../../hitch/repository.js";
...
import type { HitchCancelArgs, HitchCheckConvergenceArgs, HitchClassifyFindingArgs, HitchCloseArgs, HitchDeferFindingArgs, HitchExpandScopeArgs, HitchMarkFindingFixedArgs, HitchRecordCloseCheckArgs, HitchRecordFindingsArgs, HitchStartArgs } from "./hitch-tools-types.js";
import { MAX_FINDINGS_PER_CALL } from "./hitch-tools-types.js";
import { confirmationResult, ensureUnconfirmedHitchCloseAllowed, expandHitchScope, hitchClosePreview, hitchIdForIdempotencyKey, hitchMetadata, isConfirmed, runHitchOperation, splitRecordedConvergence, toClassifiableFinding } from "./hitch-tools-helpers.js";
